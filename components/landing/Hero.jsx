...
const copy = {
  ...
  text: "אני מביא את חוויית המסעדה אליכם – עם ארוחות שף פרטיות, שולחנות שוק, מגשי אירוח ודוכני אוכל, כולם בהתאמה אישית לאופי האירוע, עם שירות אישי והקפדה על כל פרט בדרך.",
